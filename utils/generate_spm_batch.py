...
MATLAB_BATCH_TEMPLATE = """% SPM Batch: Flexible Factorial Design (Well-Conditioned)
...
def generate_cells_code(design, subject_map):
    ...
    for g_idx, group in enumerate(groups, 1):
        for s_idx, session in enumerate(sessions, 1):
            files = design['groups'][group]['sessions'][session]
            ...
            subj_ids = [finfo['subject'] for finfo in design['files'] if finfo['path'] in files]
...
def generate_batch(args):
    ...
    print(f"\n✓ SPM batch file saved to: {output_file}")
